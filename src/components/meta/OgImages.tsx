    ...
    <div style={styles.container}>
      ...
      <div style={styles.author}>
        <img
          width="48"
          height="48"
          src="https://avatars.githubusercontent.com/u/37313988?s=96&v=4"
          style={styles.authorAvatar}
        />
        <div style={styles.authorName}>@kleviss</div>
